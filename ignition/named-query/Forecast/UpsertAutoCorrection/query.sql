...
WITH t AS (
  SELECT
    ...
    (:p_value)::numeric                                             AS auto_val,
    (:p_userid)::int                                                AS uid
)
INSERT INTO forecast.auto_forecast_settings
  (slot_ts, "datetime", "data", "hour", interval_minutes, siteid, farmid, auto_correction, userid)
SELECT t.ts, t."datetime", t."data", t."hour", t.interval_minutes, t.siteid, t.farmid, t.auto_val, t.uid
FROM t
ON CONFLICT (slot_ts, siteid, farmid) DO UPDATE SET
  auto_correction  = EXCLUDED.auto_correction,
  "datetime"       = now(),
  "data"           = EXCLUDED."data",
  "hour"           = EXCLUDED."hour",
