...
WITH t AS (
  SELECT
    ...
    (:p_value)::numeric                                             AS man_val,
    (:p_userid)::int                                                AS uid
)
INSERT INTO forecast.manual_forecast_settings
  (slot_ts, "datetime", "data", "hour", interval_minutes, siteid, farmid, manual_correction, userid)
SELECT t.ts, t."datetime", t."data", t."hour", t.interval_minutes, t.siteid, t.farmid, t.man_val, t.uid
FROM t
ON CONFLICT (slot_ts, siteid, farmid) DO UPDATE SET
  manual_correction = EXCLUDED.manual_correction,
  "datetime"        = now(),
  "data"            = EXCLUDED."data",
  "hour"            = EXCLUDED."hour",
